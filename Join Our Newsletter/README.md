...
All the required resources can be found in the `/resources` folder. You may need to optimize the resources as necessary.
...
- [ ] Optimize and resize the required resources from the `/resources` folder as necessary.
